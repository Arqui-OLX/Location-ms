...
typeorm_1.createConnection().then(function (connection) {
    ...
    app.get("/locations", function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, locationRepository.find()];
                    case 1:
                        locations = _a.sent();
                        res.json(locations);
                        return [2 /*return*/];
    ...
    app.get("/locations/:id", function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, locationRepository.findOne(req.params.id)];
                    case 1:
                        results = _a.sent();
    ...
    app.post("/locations", function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, locationRepository.create(req.body)];
                    case 1:
                        location = _a.sent();
    ...
    app.delete("/locations/:id", function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, locationRepository.delete(req.params.id)];
                    case 1:
                        results = _a.sent();
                        return [2 /*return*/, res.send(results)];
                }
